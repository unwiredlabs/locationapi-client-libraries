...
namespace unwired.Api
{
    ...
    public interface ITimezoneApi : IApiAccessor
    {
        ...
        ApiResponse<Object> TimezoneWithHttpInfo (double? lat, double? lon);
        ...
        System.Threading.Tasks.Task<Object> TimezoneAsync (double? lat, double? lon);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> TimezoneAsyncWithHttpInfo (double? lat, double? lon);
    ...
    public partial class TimezoneApi : ITimezoneApi
    {
        ...
        /// <returns></returns>
        public TimezoneApi(unwired.Client.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// timezone The Unwired Labs TimeZone API provides time offset data for locations on the surface of the earth.
        /// </summary>
        /// <exception cref="unwired.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="lat">lattitude of the location</param>
        /// <param name="lon">longitude of location</param>
        /// <returns>Object</returns>
        public Object Timezone (double? lat, double? lon)
        {
             ApiResponse<Object> localVarResponse = TimezoneWithHttpInfo(lat, lon);
        ...
        /// <param name="lon">longitude of location</param>
        /// <returns>ApiResponse of Object</returns>
        public ApiResponse< Object > TimezoneWithHttpInfo (double? lat, double? lon)
        {
            // verify the required parameter 'lat' is set
            if (lat == null)
                throw new ApiException(400, "Missing required parameter 'lat' when calling TimezoneApi->Timezone");
            // verify the required parameter 'lon' is set
            if (lon == null)
                throw new ApiException(400, "Missing required parameter 'lon' when calling TimezoneApi->Timezone");

            var localVarPath = "/timezone.php";
        ...
        /// <param name="lon">longitude of location</param>
        /// <returns>Task of Object</returns>
        public async System.Threading.Tasks.Task<Object> TimezoneAsync (double? lat, double? lon)
        {
             ApiResponse<Object> localVarResponse = await TimezoneAsyncWithHttpInfo(lat, lon);
             return localVarResponse.Data;
        ...
        /// <param name="lon">longitude of location</param>
        /// <returns>Task of ApiResponse (Object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> TimezoneAsyncWithHttpInfo (double? lat, double? lon)
        {
            // verify the required parameter 'lat' is set
            if (lat == null)
                throw new ApiException(400, "Missing required parameter 'lat' when calling TimezoneApi->Timezone");
