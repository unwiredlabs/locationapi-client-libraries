...
${nuget_cmd} install src/unwired/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/unwired.dll"
...
then
  ...
  echo "[INFO] bin/unwired.dll was created successfully"
fi
