  ...
  class GeolocationSchema
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'wifi')
        if (value = attributes[:'wifi']).is_a?(Array)
          self.wifi = value
        end
      end

      if attributes.has_key?(:'fallbacks')
        self.fallbacks = attributes[:'fallbacks']
      end
      ...
      if attributes.has_key?(:'bt')
        self.bt = attributes[:'bt']
      end
    end
    ...
    def hash
      [token, id, radio, mcc, mnc, cells, wifi, fallbacks, address, ip, bt].hash
    end
