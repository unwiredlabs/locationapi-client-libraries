...
module unwiredClient
  ...
  class GeolocationResponseSchema
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'balance_slots')
        self.balance_slots = attributes[:'balance_slots']
      end
      ...
      if attributes.has_key?(:'address_details')
        self.address_details = attributes[:'address_details']
      end

      if attributes.has_key?(:'aged')
        self.aged = attributes[:'aged']
      end
    ...
    def hash
      [status, message, balance, balance_slots, lat, lon, accuracy, address, address_details, aged, fallback].hash
    end
