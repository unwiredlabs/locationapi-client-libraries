...
module unwiredClient
  ...
  class FallbackSchema
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ipf')
        self.ipf = attributes[:'ipf']
      end

      if attributes.has_key?(:'lacf')
        self.lacf = attributes[:'lacf']
      end

      if attributes.has_key?(:'scf')
        self.scf = attributes[:'scf']
      end
    end
