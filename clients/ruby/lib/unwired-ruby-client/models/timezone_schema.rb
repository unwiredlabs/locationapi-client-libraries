...
module unwiredClient
  ...
  class TimezoneSchema
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'offset_sec')
        self.offset_sec = attributes[:'offset_sec']
      end

      if attributes.has_key?(:'now_in_dst')
        self.now_in_dst = attributes[:'now_in_dst']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          offset_sec == o.offset_sec &&
          now_in_dst == o.now_in_dst &&
          name == o.name
    end
    ...
    def hash
      [short_name, offset_sec, now_in_dst, name].hash
    end
