...
#
package WWW::OpenAPIClient::Object::WifiSchema;
...
__PACKAGE__->method_documentation({
    'bssid' => {
    	datatype => 'string',
    	base_name => 'bssid',
    	description => 'Basic Service Set Identifier or MAC address of the Access Point. Typical format of a MAC address is xx-xx-xx-xx-xx-xx. However, the delimiter can be any of these when sent to the API: : or - or .',
    	format => '',
    	read_only => '',
    		},
    'channel' => {
