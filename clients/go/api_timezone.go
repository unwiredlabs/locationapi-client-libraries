...
*/
func (a *TimezoneApiService) Timezone(ctx context.Context, lat float64, lon float64) (map[string]interface{}, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/timezone.php"
